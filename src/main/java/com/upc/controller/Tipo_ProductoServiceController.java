...
public class Tipo_ProductoServiceController {
    ...
    public ResponseEntity<Object> updateTipo_Producto(@PathVariable("CTipo_Producto") Integer CTipo_Producto,
    ...
    public ResponseEntity<Object> deleteTipo_Producto(@PathVariable("CTipo_Producto") Integer CTipo_Producto)
    {
        boolean isTipo_ProductoExist = Tipo_ProductoService.isTipo_ProductoExist(CTipo_Producto);
        if (isTipo_ProductoExist)
        {
